...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/libevent2022/libevent2022.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/hwloc201/hwloc201.h\"' \'-prefix=/usr/local\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/workspaces/HPC-studing/openmpi-4.1.8 -I/workspaces/HPC-studing/openmpi-4.1.8 -I/workspaces/HPC-studing/openmpi-4.1.8/opal/include -I/workspaces/HPC-studing/openmpi-4.1.8/opal/include -I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/event/libevent2022/libevent -I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/event/libevent2022/libevent/include -I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/hwloc/hwloc201/hwloc/include  \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2025-04-11T03:16:01"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "codespaces-ecdef3"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "codespace"
...
#define PMIX_PACKAGE_STRING "PMIx codespace@codespaces-ecdef3 Distribution"
