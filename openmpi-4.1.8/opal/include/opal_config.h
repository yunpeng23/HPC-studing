...
/* Define to 1 if you have the <ucc/api/ucc.h> header file. */
/* #undef HAVE_UCC_API_UCC_H */
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/event/libevent2022/libevent -I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/event/libevent2022/libevent/include -I/workspaces/HPC-studing/openmpi-4.1.8/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.1.8"
...
#define OPAL_IDENT_STRING "4.1.8"
...
#define OPAL_PACKAGE_STRING "Open MPI codespace@codespaces-ecdef3 Distribution"
...
#define OPAL_RELEASE_DATE "Feb 04, 2025"
...
#define OPAL_TARBALL_VERSION "4.1.8"
...
#define ORTE_RELEASE_DATE "Feb 04, 2025"
...
#define OSHMEM_RELEASE_DATE "Feb 04, 2025"

/* Release release number of Open SHMEM */
#define OSHMEM_RELEASE_VERSION 8

/* The repository version Open SHMEM */
#define OSHMEM_REPO_REV "v4.1.8"
...
#define OSHMEM_TARBALL_VERSION "4.1.8"

/* Complete release number of Open SHMEM */
#define OSHMEM_VERSION "8"
...
#define PACKAGE_STRING "Open MPI 4.1.8"
